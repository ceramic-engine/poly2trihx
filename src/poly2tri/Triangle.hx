...
class Triangle 
{
    ...
    {
        reset(p1, p2, p3, fixOrientation, checkOrientation);
    }

    inline public function reset(p1:Point, p2:Point, p3:Point, fixOrientation = false, checkOrientation = true) {
    ...
    inline public function containsEdgePoints(p1:Point, p2:Point):Bool
    {
     ...
     */
    inline public function markNeighbor(t:Triangle, p1:Point, p2:Point) 
    {
        if ((p1.equals(this.points[2]) && p2.equals(this.points[1])) || (p1.equals(this.points[1]) && p2.equals(this.points[2]))) 
        {
            this.neighbors[0] = t; 
        }
        else if ((p1.equals(this.points[0]) && p2.equals(this.points[2])) || (p1.equals(this.points[2]) && p2.equals(this.points[0]))) 
        {
            this.neighbors[1] = t;
        }
        else if ((p1.equals(this.points[0]) && p2.equals(this.points[1])) || (p1.equals(this.points[1]) && p2.equals(this.points[0]))) 
        {
            this.neighbors[2] = t;
        }
        else {
    ...
    inline public function markNeighborTriangle(that:Triangle)
    {
        ...
        else if (that.containsEdgePoints(this.points[0], this.points[2])){
            this.neighbors[1] = that;
            that.markNeighbor(this, this.points[0], this.points[2]);
        }
        
        else if (that.containsEdgePoints(this.points[0], this.points[1])) {
    ...
    // Optimized?
    inline public function getPointIndexOffset(p:Point, offset:Int = 0):Int 
    {
        var no:Int = offset;
        var didBreak = false;
        for (n in 0...3) 
    ...
    inline public function pointCW (p:Point):Point 
    { 
        return this.points[getPointIndexOffset(p, CCW_OFFSET)]; 
    }

    inline public function pointCCW(p:Point):Point
    {
        return this.points[getPointIndexOffset(p, CW_OFFSET)];
    }

    inline public function neighborCW(p:Point):Triangle 
    {
         return this.neighbors[getPointIndexOffset(p, CW_OFFSET)]; 
    }
    
    inline public function neighborCCW(p:Point):Triangle 
    { 
        return this.neighbors[getPointIndexOffset(p, CCW_OFFSET)]; 
    }

    inline public function getConstrainedEdgeCW(p:Point):Bool              { return this.constrained_edge[getPointIndexOffset(p, CW_OFFSET)]; }
    inline public function setConstrainedEdgeCW(p:Point, ce:Bool):Bool  { return this.constrained_edge[getPointIndexOffset(p, CW_OFFSET)] = ce; }

    inline public function getConstrainedEdgeCCW(p:Point):Bool             { return this.constrained_edge[getPointIndexOffset(p, CCW_OFFSET)]; }
    inline public function setConstrainedEdgeCCW(p:Point, ce:Bool):Bool { return this.constrained_edge[getPointIndexOffset(p, CCW_OFFSET)] = ce; }

    inline public function getDelaunayEdgeCW(p:Point):Bool                 { return this.delaunay_edge[getPointIndexOffset(p, CW_OFFSET)]; }
    inline public function setDelaunayEdgeCW(p:Point, e:Bool):Bool      { return this.delaunay_edge[getPointIndexOffset(p, CW_OFFSET)] = e; }
    
    inline public function getDelaunayEdgeCCW(p:Point):Bool                { return this.delaunay_edge[getPointIndexOffset(p, CCW_OFFSET)]; }
    inline public function setDelaunayEdgeCCW(p:Point, e:Bool):Bool     { return this.delaunay_edge[getPointIndexOffset(p, CCW_OFFSET)] = e; }


    /**
     * The neighbor across to given point.
     */
    inline public function neighborAcross(p:Point):Triangle { return this.neighbors[getPointIndexOffset(p, 0)]; }

    inline public function oppositePoint(t:Triangle, p:Point):Point 
    {
     ...
     * @param	p
     */
    inline public function index(p:Point):Int 
    {
        var result = -1;
        try {
            result = this.getPointIndexOffset(p, 0);
        } catch (msg:String) {
            trace(msg);
        }
        return result;
    ...
    inline public function edgeIndex(p1:Point, p2:Point):Int 
    {
        var result = -1;
        if (p1.equals(this.points[0])) 
        {
            if (p2.equals(this.points[1])) result = 2;
            else if (p2.equals(this.points[2])) result = 1;
        } 
        else if (p1.equals(this.points[1])) 
        {
            if (p2.equals(this.points[2])) result = 0;
            else if (p2.equals(this.points[0])) result = 2;
        } 
        else if (p1.equals(this.points[2])) 
        {
            if (p2.equals(this.points[0])) result = 1;
            else if (p2.equals(this.points[1])) result = 0;
        }
        return result;
    }
     ...
     */
    inline public function markConstrainedEdgeByIndex(index:Int) 
    {
        this.constrained_edge[index] = true;
    }

    inline public function markConstrainedEdgeByEdge(edge:Edge) 
    {
        this.markConstrainedEdgeByPoints(edge.p, edge.q);
    }

    inline public function markConstrainedEdgeByPoints(p:Point, q:Point) 
    {
     ...
     * @return
     */
    inline public function isEdgeSide(ep:Point, eq:Point):Bool 
    {
     ...
     * </pre>
     */
    inline static public function rotateTrianglePair(t:Triangle, p:Point, ot:Triangle, op:Point) 
    {
    ...
    inline public function clearNeigbors() 
    {
    ...
    inline public function clearDelunayEdges() 
    {
